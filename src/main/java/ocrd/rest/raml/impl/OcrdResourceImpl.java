...
import de.lmu.cis.api.model.EvaluationResult;
import de.lmu.cis.api.model.TrainData;
import de.lmu.cis.api.resource.TrainclassifierResource;
...
public class OcrdResourceImpl implements TrainclassifierResource {
  @Override
  public PostTrainclassifierResponse postTrainclassifier(TrainData entity)
      throws Exception {
    ...
    for (int i = 0; i < methods_array.length(); i++) {
      ...
      if (type.equals("svm")) {
        ...
        evalresult.append("evalstring",
                          StringEscapeUtils.escapeHtml(eval.toSummaryString()));
