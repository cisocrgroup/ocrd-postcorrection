...
import de.lmu.cis.ocrd.ml.features.HighestRankedCandidateOCRPatternsDistanceFeature;
...
public class HighestRankedCandidateOCRPatternsDistanceFeatureTest extends FeaturesTestBase {
	private Feature f;

	@Before
	public void initFeature() throws Exception {
		f = new HighestRankedCandidateOCRPatternsDistanceFeature(
				"ocr-patterns-distance");
	}
